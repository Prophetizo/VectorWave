...
public enum WaveletName {
    ...
    // Battle-Lemarié spline wavelets (simplified approximations)
    BLEM1("blem1", "Linear Battle-Lemarié (simplified)", WaveletType.ORTHOGONAL),
    BLEM2("blem2", "Quadratic Battle-Lemarié (simplified)", WaveletType.ORTHOGONAL),
    BLEM3("blem3", "Cubic Battle-Lemarié (simplified)", WaveletType.ORTHOGONAL),
    BLEM4("blem4", "Quartic Battle-Lemarié (simplified)", WaveletType.ORTHOGONAL),
    BLEM5("blem5", "Quintic Battle-Lemarié (simplified)", WaveletType.ORTHOGONAL),
