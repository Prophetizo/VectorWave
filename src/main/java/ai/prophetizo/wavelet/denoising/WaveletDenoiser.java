...
public class WaveletDenoiser {
    ...
    public WaveletDenoiser(Wavelet wavelet, BoundaryMode boundaryMode) {
        if (wavelet == null) {
            throw new NullPointerException("Wavelet cannot be null");
        }
        if (boundaryMode == null) {
            throw new NullPointerException("Boundary mode cannot be null");
        }
    ...
    private double calculateThreshold(double[] coeffs, double sigma, ThresholdMethod method) {
        ...
        switch (method) {
            ...
            case FIXED:
                ...
                throw new IllegalArgumentException("Use denoiseFixed() for fixed threshold");
                
            default:
                throw new IllegalArgumentException("Unknown threshold method: " + method);
        }
    }
